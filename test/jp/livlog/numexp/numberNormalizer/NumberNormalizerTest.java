...
import jp.livlog.numexp.numberNormalizer.impl.JapaneseNumberConverterImpl;
...
class NumberNormalizerTest {
    ...
    void processTest5Suu2() {
        ...
        this.NN = new NumberNormalizerImpl(language);
        this.NN.process(text, result);
        org.junit.Assert.assertEquals("0数", result.get(0).originalExpression);
        org.junit.Assert.assertTrue(1 == result.get(0).valueLowerbound);
        org.junit.Assert.assertTrue(9 == result.get(0).valueUpperbound);
    }
