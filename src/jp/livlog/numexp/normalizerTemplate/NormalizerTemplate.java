package jp.livlog.numexp.normalizerTemplate;
...
import jp.livlog.numexp.normalizerUtility.impl.NormalizerUtilityImpl;
    ...
    public void process(String text, List <AnyTypeExpression> anyTypeExpressions) {
        ...
        for (var i = 0; i < anyTypeExpressions.size(); i++) {
            ...
            if (this.normalizeSuffixNumberModifier(uTextReplaced, anyTypeExpressions.get(i))) {
                // TODO : 2回以上の繰り返しを本当に含めて良いのか？
                this.normalizeSuffixNumberModifier(uTextReplaced, anyTypeExpressions.get(i));
            }
